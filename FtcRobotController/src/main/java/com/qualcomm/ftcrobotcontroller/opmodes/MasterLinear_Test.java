 ...
 */
public abstract class MasterLinear_Test extends LinearOpMode {
...
//
//    public MasterLinear_Test(String myAlliance, String myStartPos, double myDelay, String parkCheck) {
//        alliance = myAlliance;
//        startPos = myStartPos;
